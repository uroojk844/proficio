...
function Contact() {
  return (
    <section className="min-h-[calc(100dvh-76px)] grid content-center py-16">
      <h1 className="text-5xl font-bold text-center mb-12">Contact us</h1>

      <div className="px-6 max-w-5xl xl:max-w-6xl w-full mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10">
        <div className="w-full relative aspect-video rounded-md overflow-hidden sm:col-span-2">
          <iframe
